...
SECRET_KEY = env(
    "SECRET_KEY",
    default="django-insecure-cmql!s5e=ktlg#4u1w3f!c@xlydya(hb&!t^2bb8o_=qbzf1(2",
)
...
DATABASES = {
    "default": {
        ...
        "NAME": env("DB_NAME", default="health_records_db"),
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="noreply@healthrecords.com")
